...
const BROKERS = [
  ...
  },
  {
    ...
    label: 'Balanz',
    Logo: BalanzLogo,
    summary: 'Exportás tu historial de órdenes — un solo archivo, 1 minuto.',
    steps: [
      'En Balanz (web o app) → Operaciones → Órdenes.',
      'Poné el rango de fechas desde lo más antiguo posible hasta hoy.',
      'Tocá "Exportar" (descarga un Excel/CSV con todas tus órdenes).',
      'Subí el archivo acá.',
    ],
    parserNote: 'Importamos tus compras y ventas de títulos ejecutadas (acciones, bonos, ONs, letras, FCI) y reconstruimos tus posiciones con FIFO. Las órdenes canceladas/rechazadas se ignoran. Por ahora NO tomamos del export los movimientos de caja (depósitos/retiros) ni las compras de dólar MEP — si necesitás ajustar el saldo, lo cargás a mano en el paso siguiente.',
  },
  {
    id: 'binance',
    label: 'Binance',
