...
const BROKERS = [
  ...
  },
  {
    ...
    label: 'Balanz',
    Logo: BalanzLogo,
    summary: 'Pedimos 3 reportes del menú Actividad → Reportes. Te llevan 2 minutos.',
    steps: [
      'En la app de Balanz → tab Actividad → Reportes → "Resultados del período".',
      'Poné fechas desde lo más antiguo posible hasta hoy. Sirve cualquier rango histórico — cuanto más viejo, mejor.',
      'Descargá 3 informes con esas mismas fechas: cambiá la opción "Informe" entre Realizado, Posición final y Posición inicial.',
      'Si tenés FCI: descargá también el "Resumen mensual Cuotapartista" del último mes que tengas FCI.',
      'Subí los archivos acá uno por uno (o todos juntos).',
    ],
    parserNote: 'Combinamos los 3 reportes para reconstruir tu historial: Realizado da operaciones cerradas, Posición final los holdings actuales, Posición inicial el baseline. Si subís solo uno, lo procesamos pero la imagen queda parcial.',
  },
  {
    id: 'binance',
    label: 'Binance',
