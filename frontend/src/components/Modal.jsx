...
export default function Modal({ title, onClose, children, wide = false }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm sm:p-4 overflow-y-auto">
      <div className={`bg-bg-raised border border-line rounded-t-2xl sm:rounded-xl w-full ${wide ? 'max-w-3xl' : 'max-w-lg'} shadow-2xl max-h-[95vh] sm:max-h-[90vh] flex flex-col`}>
