...
export const STOCKS_US = [
  ...
  { s: 'MRK', n: 'Merck' }, { s: 'NVO', n: 'Novo Nordisk' }, { s: 'ADBE', n: 'Adobe' }, { s: 'PEP', n: 'PepsiCo' },
  ...
  { s: 'PBR', n: 'Petrobras' }, { s: 'VALE', n: 'Vale' }, { s: 'ITUB', n: 'Itaú Unibanco' }, { s: 'RIO', n: 'Rio Tinto' },
...
export const CEDEARS_LIST = [
  ...
  { s: 'LLY', n: 'Eli Lilly' }, { s: 'NVO', n: 'Novo Nordisk' }, { s: 'BMY', n: 'Bristol-Myers' }, { s: 'GILD', n: 'Gilead' },
  ...
  { s: 'MELI', n: 'MercadoLibre' }, { s: 'PBR', n: 'Petrobras' }, { s: 'VALE', n: 'Vale' }, { s: 'RIO', n: 'Rio Tinto' },
