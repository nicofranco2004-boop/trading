...
export const SECTOR_META = {
  tecnologia:    { label: 'Tecnología',          color: 'rgb(var(--rendi-accent))' },
  semis:         { label: 'Semiconductores',     color: 'rgb(var(--cat-indigo))' },
  comunicacion:  { label: 'Comunicación y medios', color: 'rgb(var(--data-violet))' },
  consumo_disc:  { label: 'Consumo discrecional', color: 'rgb(var(--cat-magenta))' },
  consumo_bas:   { label: 'Consumo básico',      color: 'rgb(var(--cat-pink))' },
  salud:         { label: 'Salud',               color: 'rgb(var(--data-cyan))' },
  financiero:    { label: 'Financiero',          color: 'rgb(var(--rendi-pos))' },
  energia:       { label: 'Energía',             color: 'rgb(var(--data-amber))' },
  utilities:     { label: 'Servicios públicos',  color: 'rgb(var(--cat-bronze))' },
  industria:     { label: 'Industria',           color: 'rgb(var(--cat-olive))' },
  materiales:    { label: 'Materiales',          color: 'rgb(var(--cat-brown))' },
  inmobiliario:  { label: 'Inmobiliario',        color: 'rgb(var(--cat-teal))' },
  commodities:   { label: 'Oro y commodities',   color: 'rgb(var(--cat-gold))' },
  diversificado: { label: 'Diversificado (ETF)', color: 'rgb(var(--cat-steel))' },
  cripto:        { label: 'Cripto',              color: 'rgb(var(--cat-orange))' },
  renta_fija:    { label: 'Renta fija',          color: 'rgb(var(--cat-slate-2))' },
  fci:           { label: 'FCI',                 color: 'rgb(var(--cat-slate))' },
  efectivo:      { label: 'Efectivo',            color: 'rgb(var(--ink-3))' },
  sin_dato:      { label: 'Sin dato',            color: 'rgb(var(--cat-gray-2))' },
}
