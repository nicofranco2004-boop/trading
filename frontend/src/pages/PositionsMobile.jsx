...
export default function PositionsMobile() {
  ...
  const grouped = useMemo(() => {
    ...
    return groups
  }, [filteredByBroker, brokerFilter, brokers, sortBy, expandedTickers, showAllLots, tcValuacion])
  ...
  }, [filteredByBroker, brokerFilter, sortBy, expandedTickers, showAllLots, tcValuacion])
...
const PositionRow = memo(function PositionRow({ p, displayCurrency = 'USD', tcValuacion = 1, onSell, onCashFlow, onEditPos, onDeletePos, onToggleTicker }) {
  ...
  const pnlDisplay = displayCurrency === 'ARS' ? p.pnlUsdToday * tcValuacion : p.pnlUsd
