// AdvisorClients — el roster del Plan Asesor (/clientes).
// ═══════════════════════════════════════════════════════════════════════════
...
//
// Split del 2026-07-23: el libro (AUM total, motor estrella, colas, distribución)
// vivía acá bundleado (F3) — se separó a AdvisorDashboard.jsx (/dashboard cuando
// isAdvisor && !clientCtx). Esta página quedó SOLO roster: agregar/invitar/
// operación grupal/notas — ningún dato agregado del libro.
//
...
export default function AdvisorClients() {
  ...
  const load = useCallback(async () => {
    try {
      ...
      // segundo plano) no debe vaciarlo a "sin clientes".
