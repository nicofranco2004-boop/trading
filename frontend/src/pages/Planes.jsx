...
// ─── Pricing ─────────────────────────────────────────────────────────────────
// Los precios viven en data/pricing.js (ver el porqué allá). Se re-exportan
// para no romper a los que importan desde esta página.
import {
  ...
  fmtArs, annualSavingsArs, annualDiscountPct, ANNUAL_DISCOUNT_BADGE_PCT,
} from '../data/pricing'
...
// Las 3 listas de features viven ahora en data/planCatalog.js (fuente única,
// compartida con la sección Planes de /config). Se re-exportan acá para
// mantener la API previa de este módulo intacta.
export { FREE_FEATURES, PLUS_FEATURES, PRO_FEATURES }
