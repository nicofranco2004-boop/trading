...
CREATE TABLE IF NOT EXISTS flujo_resoluciones (
  ...
  aplicado bigint NOT NULL DEFAULT 0,
  aprobado_por bigint,
  aprobado_at text,
  revocado_at text,
  batch_ref text,
...
CREATE TABLE IF NOT EXISTS twr_periods (
  ...
  retract_ref text,
  retracted_at text,
  metodo text NOT NULL DEFAULT 'medido',
  flow_source text,
  confianza double precision,
  fx_basis_v0 text,
  fx_basis_v1 text,
...
CREATE INDEX IF NOT EXISTS idx_twr_periods_vigente ON twr_periods(user_id, month, estado);
